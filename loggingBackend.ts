...
export class LoggingFormatter {
  ...
  styleDebuggingInformation(
    ...
    const name = this.bold(this.italic(info.name ?? "anonymous"));
    const file = info.file ? ` in ${this.styleFilePath(info.file)}` : "";
    const position = info.file && info.line
      ? this.yellow(`:${info.line}${info.column ? `:${info.column}` : ""}`)
      : "";
   ...
   */
  styleFilePath(path: string): string {
    return this.cyan(path);
  }
   ...
   */
  bgBrightBlack(s: string): string {
    return this.backend.bgBrightBlack(s);
  }
   ...
   */
  bgBrightBlue(s: string): string {
    return this.backend.bgBrightBlue(s);
  }
   ...
   */
  bgBrightCyan(s: string): string {
    return this.backend.bgBrightCyan(s);
  }
   ...
   */
  bgBrightGreen(s: string): string {
    return this.backend.bgBrightGreen(s);
  }
   ...
   */
  bgBrightMagenta(s: string): string {
    return this.backend.bgBrightMagenta(s);
  }
   ...
   */
  bgBrightRed(s: string): string {
    return this.backend.bgBrightRed(s);
  }
   ...
   */
  bgBrightWhite(s: string): string {
    return this.backend.bgBrightWhite(s);
  }
   ...
   */
  bgBrightYellow(s: string): string {
    return this.backend.bgBrightYellow(s);
  }
   ...
   */
  bgMagenta(s: string): string {
    return this.backend.bgMagenta(s);
  }
   ...
   */
  bgYellow(s: string): string {
    return this.backend.bgYellow(s);
  }
   ...
   */
  brightBlack(s: string): string {
    return this.backend.brightBlack(s);
  }
   ...
   */
  brightBlue(s: string): string {
    return this.backend.brightBlue(s);
  }
   ...
   */
  brightCyan(s: string): string {
    return this.backend.brightCyan(s);
  }
   ...
   */
  brightGreen(s: string): string {
    return this.backend.brightGreen(s);
  }
   ...
   */
  brightMagenta(s: string): string {
    return this.backend.brightMagenta(s);
  }
   ...
   */
  brightRed(s: string): string {
    return this.backend.brightRed(s);
  }
   ...
   */
  brightWhite(s: string): string {
    return this.backend.brightWhite(s);
  }
   ...
   */
  brightYellow(s: string): string {
    return this.backend.brightYellow(s);
  }
   ...
   */
  strikethrough(s: string): string {
    return this.backend.strikethrough(s);
  }
   ...
   */
  underline(s: string): string {
    return this.backend.underline(s);
  }
